export interface DemoQuery {
  id: string;
  category: "Basic Queries" | "Filtering" | "Sorting" | "Aggregates" | "Joins" | "Transactions" | "Constraints";
  title: string;
  sql: string;
  intentionalError?: boolean;
}

export const demoWorkspaceName = "KansoDB Sample Workspace";
export const demoWorkspaceDatabaseName = "acme-corporation.db";

export const demoWorkspaceSql = `
...
export const demoQueries: DemoQuery[] = [
  ...
  {
    id: "filter-high-salary",
    category: "Filtering",
    title: "High salaries",
    sql: "SELECT name, salary\nFROM employees\nWHERE salary >= 90000\nORDER BY salary DESC;"
  },
  {
    id: "filter-open-tasks",
    category: "Filtering",
    title: "Open tasks",
    sql: "SELECT title, status, estimate_hours\nFROM tasks\nWHERE completed = FALSE\nORDER BY estimate_hours DESC\nLIMIT 10;"
  },
  {
    id: "sorting-budget",
    category: "Sorting",
    title: "Largest budgets",
    sql: "SELECT name, budget, status\nFROM projects\nORDER BY budget DESC\nLIMIT 5;"
  },
  {
    id: "aggregate-departments",
    category: "Aggregates",
    title: "Department payroll",
    sql: "SELECT department_id, COUNT(*) AS employees, AVG(salary) AS average_salary, SUM(salary) AS payroll\nFROM employees\nGROUP BY department_id\nORDER BY payroll DESC;"
  },
  {
    id: "aggregate-task-load",
    category: "Aggregates",
    title: "Project task load",
    sql: "SELECT project_id, COUNT(*) AS tasks, SUM(estimate_hours) AS estimated_hours\nFROM tasks\nGROUP BY project_id\nORDER BY estimated_hours DESC\nLIMIT 8;"
  },
  {
    id: "join-employee-departments",
    category: "Joins",
    title: "Employees by department",
    sql: "SELECT e.name, d.name AS department, o.city AS office\nFROM employees e\nINNER JOIN departments d ON e.department_id = d.id\nINNER JOIN offices o ON e.office_id = o.id\nORDER BY e.name ASC\nLIMIT 12;"
  },
  {
    id: "join-project-clients",
    category: "Joins",
    title: "Projects and clients",
    sql: "SELECT p.name AS project, c.name AS client, p.budget\nFROM projects p\nINNER JOIN clients c ON p.client_id = c.id\nORDER BY p.budget DESC\nLIMIT 8;"
  },
  {
    id: "insert-audit",
    category: "Basic Queries",
    title: "Insert audit event",
    sql: "INSERT INTO audit_log VALUES (6, 1, 'demo query executed', '2026-07-22');"
  },
  {
    id: "update-task",
    category: "Basic Queries",
  ...
  },
  {
    ...
    sql: "INSERT INTO employees VALUES (31, 'amira.rahman@acme.test', 'Amira Duplicate', 1, 1, 82000, TRUE);",
    intentionalError: true
  }
];

export const demoWorkspaceDescription = "Acme Corporation sample data with offices, departments, employees, clients, projects, assignments, tasks, salaries, and audit events.";
